...
def main():
    ...
    # Estadísticas en df_mentions (ajustar según las columnas reales)
    ...
    # Estadísticas en df_states (ajustar según las columnas reales)
    ...
    # Estadísticas en df_temporal (ajustar según las columnas reales)
    ...
    # Estadísticas en df_engagement (ajustar según las columnas reales)
